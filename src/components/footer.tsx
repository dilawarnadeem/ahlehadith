        ...
        <div className="py-12 flex md:flex-row flex-col gap-4 border-b border-yellow">
          <div className="md:w-1/3 w-full flex gap-3">
            ...
            <div>
              ...
              <Link
                href="tel:03060483779"
                className="md:text-4xl text-2xl text-white uppercase font-ahle"
              >
                97 73 840 0306 92+
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-4">
            <div>
              ...
              <p className="text-white font-ahle text-lg">
                منہج سلف پر قرآن وحدیث کی تبلیغ واشاعت کی علمبردار - مرکزی
                    ...
                    <ul className="list-inside list-square marker:text-yellow">
                      {item.sub_menu?.map((sub_item: any, _idx: any) => {
                        return (
                          <li
                            key={_idx}
                            className="mb-4 relative before:content-[' '] before:h-[1px] before:w-3 before:bg-[#397524] before:absolute before:top-[13px] before:right-1"
                          >
                            <Link
                              href={sub_item.link}
                              className="text-white hover:opacity-80 font-ahle text-lg ms-1"
                            >
                              {sub_item.name}
                            </Link>
                          </li>
            ...
            <div className="border border-yellow grid md:grid-cols-4 grid-cols-1 gap-5 items-center ">
              ...
              <ul className="flex md:justify-end">
                <li className="p-3 md:border-r md:border-y-0 md:border-l-0 border border-yellow bg-transparent hover:bg-yellow text-white">
                  <Link
                    href="https://www.facebook.com/MjahOfficial"
                    target="_blank"
                    className=""
                  >
                    <FaFacebookF size={20} />
                ...
                <li className="p-3 md:border-r md:border-y-0 md:border-l-0 border border-yellow bg-transparent hover:bg-yellow text-white">
                  <Link
                    href="https://www.tiktok.com/@mjah106"
                    target="_blank"
                    className=""
                  >
                    <FaTiktok size={20} />
                ...
                <li className="p-3 md:border-r md:border-y-0 md:border-l-0 border border-yellow bg-transparent hover:bg-yellow text-white">
                  <Link
                    href="https://www.youtube.com/@MarkaziJamiatAhleHadeesPakista"
                    target="_blank"
                    className=""
                  >
                    <FaYoutube size={20} />
